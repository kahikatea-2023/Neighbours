...
function Header() {
  ...
  return (
    <div className="pl-4 pt-3 pr-4 flex justify-between items-center">
      ...
      <nav
        className={`fixed left-0 top-12 h-full w-full backdrop-filter backdrop-blur-md text-white bg-lightGreen bg-opacity-90 shadow-transparent transition-all ease-in-out duration-200 ${
